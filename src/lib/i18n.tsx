...
const EN: Dict = {
  ...
  "hero.title_a": "60 days.",
  "hero.title_b": "One generation.",
  ...
  "hero.cta_challenges": "See the 60 Challenges",
  ...
  "what.lede": "A 60-day global immersion. Daily themes. Real research. Real action. Real institutional transformation.",
  "cards.themes.t": "Daily Themes",
  "cards.themes.d": "12 themes rotated across 60 days — energy, food, justice, biodiversity & more.",
  ...
  "cards.action.d": "November unlocks an action toolkit personalized to what you researched.",
  "cards.resume.t": "Impact Resume",
  "cards.resume.d": "Every submission auto-compiles into a downloadable climate resume.",
  "cards.bracket.t": "University Index",
  "cards.bracket.d": "Compete on Research and Impact leaderboards against 800+ schools.",
  "cards.ai.t": "PGC AI Assistant",
  "cards.ai.d": "An on-site research companion that helps you interpret data and frame actions.",
  "cta.strip.title": "Your campus needs you on the leaderboard.",
  "cta.strip.lede": "Sign up in 60 seconds. Add your university. Start earning points the moment Day 1 unlocks.",
  "cta.strip.standings": "See standings",
  "footer.tag": "60 days. One generation. PGC 2026 turns curious students into informed, active, global leaders for a thriving planet.",
